...
pub fn init(device: Device, width: i32, height: i32, format: Format) !Texture {
    const h = c.nmCreateTexture(device.handle, width, height, @intFromEnum(format))
...
pub fn uploadRegion(self: Texture, x: i32, y: i32, width: i32, height: i32,
                    data: []const u8, row_pitch: usize) void {
